    ...
    <>
      <div className={classNames("container-fluid", styles.shos_css)}>
        ...
        <div className="container-fluid">
          <div className={classNames("row g-2", styles.fila_container)}>
            <div className={classNames("col-6 ", styles.container_cocierto)}>
        ...
        <div className="container-fluid">
          <div className={classNames("row g-2", styles.fila_container)}>
            <div className={classNames("col-6 d-flex justify-content-center")}>
